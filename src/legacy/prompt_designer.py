...
Maintenance cost: 100,000 + 100x Total cost: 100x + 250x + 100,000 + 100x = 450x + 100,000 ASSISTANT The student's solution is correct.
...
Land cost: 100x
Solar panel cost: 250x
Maintenance cost: 100,000 + 100x Total cost: 100x + 250x + 100,000 + 100x = 450x + 100,000 ASSISTANT Let x be the size of the installation in square feet.
Land cost: 100x
Solar panel cost: 250x
Maintenance cost: 100,000 + 10x Total cost: 100x + 250x + 100,000 + 10x = 360x + 100,000
...
SYSTEM You can write and execute Python code by enclosing it in triple backticks, e.g. code goes here. Use this to perform calculations. USER Find all real-valued roots of the following polynomial: 3x**5 - 5x4 - 3*x3 - 7*x - 10.
...
"""
    ...
    messages = [{"role": "system", "content": f"{prompt}"},
                {"role": "user", "content": f"{desired_output}"}]
...
desired_outcome = st.text_input("Paste your desired prompt outcome here 👇", placeholder='I want summarize a book. I am interested in...')
if st.button("Start"):
    output = create_prompt(desired_outcome)
    st.write(output)
